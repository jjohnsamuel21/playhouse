...
const visual = GAME_VISUALS['this-or-that'];
      ...
      <div className="max-w-lg mx-auto">
        ...
        <div className="flex items-start justify-between mt-4 mb-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="font-display font-bold text-2xl text-playhouse-text-primary m-0">This or That</h1>
              <p className="text-playhouse-text-secondary text-[13.5px] mt-0.5 m-0">Pick a category</p>
            </div>
          </div>
          <button
